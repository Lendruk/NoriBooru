  ...
  <div class={`${!showOptions ? 'hidden' : 'flex' } flex-1 w-full h-full absolute top-0`}>
    <div class="flex flex-1 flex-col">
      ...
      <div class="flex gap-4 flex-1 items-end justify-end justify-items-end m-2">
        <GalleryItemButton>
          <svg xmlns="http://www.w3.org/2000/svg" height="16" width="14" viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2023 Fonticons, Inc.--><path d="M0 80V229.5c0 17 6.7 33.3 18.7 45.3l176 176c25 25 65.5 25 90.5 0L418.7 317.3c25-25 25-65.5 0-90.5l-176-176c-12-12-28.3-18.7-45.3-18.7H48C21.5 32 0 53.5 0 80zm112 32a32 32 0 1 1 0 64 32 32 0 1 1 0-64z"/></svg>
        </GalleryItemButton>
  
        {#if confirmingDelete}
          <GalleryItemButton onClick={onConfirmDelete} bgColor="#ed3424" iconColor="#ffffff" hoverBgColor="#a81d11">
